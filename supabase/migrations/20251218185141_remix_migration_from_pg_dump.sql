...
CREATE TABLE public.church_settings (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    church_name text DEFAULT 'Igreja VERBO'::text NOT NULL,
    ...
    pwa_name text DEFAULT 'VERBO'::text,
    pwa_short_name text DEFAULT 'VERBO'::text,
    ...
    seo_title text DEFAULT 'VERBO - Aplicativo da Igreja'::text,
